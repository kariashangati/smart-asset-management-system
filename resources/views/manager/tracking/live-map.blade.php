...
@section('title', 'Department Live Map')
...
<div class="content-card">
    <div class="section-header">
        <div>
            ...
            <p>Real-time locations for assets within your department. Click a pin for details.</p>
        </div>
    </div>
    ...
    <form method="GET" action="{{ route('manager.tracking.live-map') }}" class="filter-form">
        <div class="filter-grid">
            ...
            <div class="button-row" style="align-self:end;">
                ...
                <a href="{{ route('manager.tracking.live-map') }}" class="btn-light">Reset</a>
            </div>
        </div>
    </form>
...
<script>
    (function () {
        ...
        function buildInfoContent(asset) {
            ...
            return '<div style="padding:6px 2px; min-width:190px; font-family:inherit;">'
