...
<div class="page-heading">
    ...
    <div class="button-row">
        <button type="button" class="btn btn-primary" data-modal-open="createGeofenceModal">
            + Create Geofence
        </button>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr data-geofence-id="{{ $geofence->id }}"
                    ...
                    <td class="inline-actions">
                        ...
                        <form method="POST" action="{{ route('admin.geofences.destroy', $geofence) }}" class="js-confirm-delete" data-title="Delete geofence" data-text="Perimeter {{ $geofence->name }} will be removed.">
                            @csrf @method('DELETE')
    ...
    document.addEventListener('DOMContentLoaded', () => {
        document.querySelectorAll('.edit-geofence-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                form.action = '/admin/geofences/' + geofenceId;
