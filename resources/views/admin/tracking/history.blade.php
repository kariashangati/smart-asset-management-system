...
<div class="page-heading">
    <div>
        ...
        <p class="breadcrumb-trail">
            <a href="{{ route('admin.dashboard') }}">Dashboard</a> / <span>History</span>
        </p>
    </div>
</div>
        ...
        <table class="app-table" data-datatable="true">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.tracking.asset-history', $asset) }}" class="btn btn-outline btn-sm">View full history</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
